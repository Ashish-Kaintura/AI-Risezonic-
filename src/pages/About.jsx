  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 animated-gradient-overlay z-0"></div>

        {/* Content */}
        <div className="relative z-10 max-w-4xl px-6">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 flex items-center justify-center gap-2 text-pink-500 uppercase">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-gray-700 leading-relaxed text-lg">
              AI.Risezonic is a next-gen AI company focused on democratizing
              access to Generative AI through practical training, AI software
              solutions, and innovative educational tools. We help institutions,
              startups, and individuals bridge the AI gap with real-world
              knowledge, projects, and mentorship.
            </p>
          </div>
          <img
      ...
      {/* Vision */}
      <section
        className="bg-gradient-to-r from-blue-50 via-white to-blue-50 py-16 px-6 md:px-12"
        data-aos="fade-up"
      >
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-semibold text-blue-800 mb-4 flex items-center justify-center gap-2">
            <FaEye className="inline text-blue-500" /> Our Vision
          </h2>
          <p className="text-lg text-gray-700">
            To be India’s most impactful ecosystem for AI learning, innovation,
            and application.
          </p>
        </div>
      </section>
      {/* Mission */}
      <section
        className=" max-w-7xl mx-auto my-4 py-20 px-6 md:px-12 bg-white shadow-2xl rounded-xl"
        data-aos="fade-up"
      >
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-semibold text-blue-800 mb-6 text-center flex items-center justify-center gap-2">
            <FaBullseye className="inline text-blue-500" /> Our Mission
          </h2>
          <ul className="space-y-4 text-lg text-gray-700 list-disc list-inside max-w-xl mx-auto">
            <li>
              Train <strong>10,000+</strong> learners in Generative AI
            </li>
            <li>
              Enable <strong>1,000+</strong> student-led AI projects
            </li>
            <li>
              Collaborate with <strong>100+</strong> institutions by 2026
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className=" bg-blue-50 py-20 px-6 md:px-12" data-aos="fade-up">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-semibold text-blue-800 mb-12 text-center flex items-center justify-center gap-2">
            <FaLightbulb className="inline text-yellow-500" /> Our Core Values
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
              <FaGlobeAsia className="text-4xl text-blue-600 mb-4 mx-auto" />
              <h3 className="font-semibold text-gray-800 text-center">
