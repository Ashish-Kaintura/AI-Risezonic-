...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <section className="max-w-7xl mx-auto bg-gradient-to-r from-gray-500 via-gray-400 to-gray-400 py-16 px-6 md:px-12 rounded-lg shadow-lg text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {/* Card 1 */}
          <div
            className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition hover:ring-2 hover:ring-blue-300 hover:ring-opacity-50"
            data-aos="fade-up"
          >
            <FaProjectDiagram className="text-4xl text-blue-600 mb-4 mx-auto" />
            <p className="text-lg font-semibold text-gray-800">
              10+ Hands-on AI Projects
            </p>
            <p className="text-sm text-gray-600 mt-2">
              Build real-world skills through practical experience.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-sm text-gray-600 mt-2">
              Trusted by a large community of enthusiastic learners.
            </p>
          </div>
          ...
          <div
            ...
            data-aos-delay="200"
          >
            <FaUniversity className="text-4xl text-blue-600 mb-4 mx-auto" />
            <p className="text-lg font-semibold text-gray-800">
              20+ Institutions Engaged
            </p>
            <p className="text-sm text-gray-600 mt-2">
              Collaborations with top colleges and learning centers.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-sm text-gray-600 mt-2">
              Learn by doing—every concept backed by a practical task.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Focus Areas */}
      <section className="max-w-7xl mx-auto bg-blue-50 py-16 px-6 md:px-12 rounded-lg shadow-lg">
        <h2
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div
            ...
            data-aos-delay="0"
          >
            <FaRobot className="text-4xl text-blue-600 mb-4 mx-auto" />
            <h3 className="text-lg font-semibold text-gray-800 mb-2 text-center">
              Generative AI Training
            </h3>
            <p className="text-sm text-gray-600 text-center">
              LLMs, Prompt Engineering, RAG, LangChain & more.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-sm text-gray-600 text-center">
              LMS platforms, Assessment Bots, Virtual Tutors.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-sm text-gray-600 text-center">
              Chatbots, AI Assistants, Automation Solutions.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-sm text-gray-600 text-center">
              Voice-controlled robots, drones, edge-AI integrations.
            </p>
          </div>
        </div>
      </section>
