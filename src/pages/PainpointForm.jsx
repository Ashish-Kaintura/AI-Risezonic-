...
const PainpointForm = () => {
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto p-6 mt-12 bg-white shadow-xl rounded-2xl border border-gray-200">
        <h2 className="text-4xl font-bold mb-6 text-center text-blue-700 flex items-center justify-center gap-2">
        ...
        >
          ...
          <div>
            ...
            <select
              ...
              className={`w-full border px-4 py-3 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-400 ${
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  value={formData.name}
                  onChange={handleChange}
                  className={`w-full border pl-10 pr-4 py-3 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-400 ${
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white font-semibold py-3 px-4 rounded-lg hover:bg-blue-700 transition duration-200 flex items-center justify-center gap-2"
          >
            <FaThumbtack className="inline" />
            Submit Your Pinpoint
          </button>
        </form>
      </div>
    </section>
